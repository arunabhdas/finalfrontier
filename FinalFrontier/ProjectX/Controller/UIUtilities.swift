...
public class UIUtilities {
    ...
    public static func addCircle(
        ...
        circleView.alpha = UtilConstants.circleViewAlpha
    ...
    public static func addRectangle(_ rectangle: CGRect, to view: UIView, color: UIColor) {
        ...
        rectangleView.layer.cornerRadius = UtilConstants.rectangleViewCornerRadius
        rectangleView.alpha = UtilConstants.rectangleViewAlpha
    ...
    public static func addShape(withPoints points: [NSValue]?, to view: UIView, color: UIColor) {
        ...
        shapeView.alpha = UtilConstants.shapeViewAlpha
